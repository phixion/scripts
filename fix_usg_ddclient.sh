...
# Download working ddclient and replace the existing version
cd /tmp
curl -L -O https://raw.githubusercontent.com/phixion/scripts/master/ddclient
...
update dns dynamic interface pppoe0 && sleep 20 && show dns dynamic status
