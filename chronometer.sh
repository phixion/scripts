...
outputLogo() {
  echo -e "${redColor}.${yellowColor}-${greenColor}.${blueColor}.   ${greenColor}.      ${magentaColor}.      "

  echo -e "${yellowColor}|${greenColor}-${blueColor}'${magentaColor}. ${yellowColor}- ${blueColor}|${magentaColor}-${redColor}. ${greenColor}.${blueColor}-${magentaColor}.${redColor}| ${greenColor}.${blueColor}-${magentaColor},  ${resetColor}"

  echo -e "${greenColor}'  ${redColor}'   ${magentaColor}' ${yellowColor}'${greenColor}-${blueColor}\`${magentaColor}-${redColor}'${yellowColor}'${greenColor}-${blueColor}\`${magentaColor}'${redColor}-  ${resetColor}"

  echo ""
}

outputNetworkInformation() {
  echo -e "\e[33mNETWORK ====================================================\e[0m"
  printf " %-10s%-19s %-9s%-18s\n" "Hostname:" "$(hostname)" "Domain:" ${PIHOLE_DOMAIN}
  printf " %-10s%-19s %-9s%-18s\n" "IPv4:" "${IPV4_ADDRESS}"
  printf " %-10s%-19s\n" "IPv6:" "${IPV6_ADDRESS}"
